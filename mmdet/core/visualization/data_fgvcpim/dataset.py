...
def build_loader(val_root):
    val_set, val_loader = None, None
    if val_root is not None:
        val_set = ImageDataset(istrain=False, root=val_root, data_size=384, return_index=True)
        val_loader = torch.utils.data.DataLoader(val_set, num_workers=1, shuffle=True, batch_size=8)
