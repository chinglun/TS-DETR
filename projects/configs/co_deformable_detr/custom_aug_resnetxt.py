...
model = dict(
    ...
    query_head=dict(
        ...
        loss_iou=dict(type='DIoULoss', loss_weight=2.0)),
    roi_head=[dict(
        ...
        bbox_head=dict(
            ...
            loss_cls=dict(
                type='CrossEntropyLoss', use_sigmoid=True, loss_weight=1.0*num_dec_layer*lambda_2),#mod
            loss_bbox=dict(type='DIoULoss', loss_weight=10.0*num_dec_layer*lambda_2)))],
    bbox_head=[dict(
        type='CoATSSHead',
        num_classes=1,
        in_channels=256,
        ...
        loss_bbox=dict(type='SIoULoss', loss_weight=2.0*num_dec_layer*lambda_2),
...
train_pipeline = [
    ...
    dict(type='CircleObjectAugmentation',all_objects=True,thresh=300*300,prob=0.7),
    ...
    #dict(type='SmallObjectAugmentation',one_object=True,thresh=50*500,prob=0.3),
